...
public final class Mensaje {
	...
	private Mensaje(final CodigoMensaje mensaje, final TipoMensaje tipo, final CategoriaMensaje categoria, final String contenido) {
		setCodigo(mensaje);
		setTipo(tipo);
	...
	public static final Mensaje crear(final CodigoMensaje mensaje, final TipoMensaje tipo, final CategoriaMensaje categoria, final String contenido) {
		return new Mensaje(mensaje, tipo, categoria, contenido);
	}
